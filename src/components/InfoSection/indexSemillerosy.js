...
import { InfoContainery, InfoWrapper, InfoRow, Column1, Column2, TextWrapper, TopLine, Heading, Subtitle, ImgWrap, Img } from './infoElementsSemilleros';

const SemillerosSectiony = ({lightBg, id, imgStart, topLine, lightText, headline, darkText, description, inves, img, alt}) => {
  return (
    <>
    <InfoContainery lightBg={lightBg} id={id}>
        <InfoWrapper>
...
export default SemillerosSectiony